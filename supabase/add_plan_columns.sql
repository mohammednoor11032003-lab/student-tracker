...
ADD COLUMN IF NOT EXISTS memorized_ajza INTEGER[] DEFAULT '{1}',
ADD COLUMN IF NOT EXISTS current_review_index INTEGER DEFAULT 0,
ADD COLUMN IF NOT EXISTS is_in_consolidation BOOLEAN DEFAULT false,
ADD COLUMN IF NOT EXISTS consolidation_day INTEGER DEFAULT 0,
ADD COLUMN IF NOT EXISTS consolidation_juz INTEGER DEFAULT 0,
